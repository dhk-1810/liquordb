  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm mb-4 transition-all">
      ...
      {review.reviewDetail && (review.reviewDetail.type === 'BEER' || review.reviewDetail.type === 'WINE' || review.reviewDetail.type === 'WHISKY') && (
        <div className="mt-2 mb-4 p-3.5 bg-slate-50 rounded-2xl border border-slate-100/80 grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs animate-fade-in">
    ...
    <>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-2/5 bg-slate-50 relative flex items-center justify-center border-b md:border-b-0 md:border-r border-slate-200 min-h-[350px] overflow-hidden">
            {liquor.imageUrl ? (
              <img 
                src={liquor.imageUrl} 
                alt={liquor.name} 
