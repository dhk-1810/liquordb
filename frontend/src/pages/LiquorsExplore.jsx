...
function LiquorsExplore() {
  ...
  const fetchLiquors = useCallback(async (reset = false) => {
    try {
      setIsLoading(true);
      setError(null);
      ...
      if (!reset && nextCursor !== null && nextCursor !== undefined) params.append('cursor', nextCursor);
      if (!reset && idAfter !== null && idAfter !== undefined) params.append('idAfter', idAfter);
  ...
  }, [category, keyword, nextCursor, idAfter, sortBy, t]);
  ...
  }, [isLoading, hasNext, fetchLiquors]);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in-up">
        ...
        <form onSubmit={handleSearchClick} className="flex flex-col md:flex-row gap-4 items-center">
          ...
          <div className="w-full md:w-48">
            ...
            >
              ...
              <option value="COCKTAIL">{t('liquors.categories.cocktail')}</option>
            ...
            <Link to={`/liquors/${liquor.id}`} key={liquor.id} className="group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100 transform hover:-translate-y-1">
              ...
              <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="flex items-center gap-1.5 mb-4">
                  ...
                  <span className="font-semibold text-slate-700">{(liquor.averageRating ?? 0).toFixed(1)}</span>
      ...
      <div ref={loadMoreRef} className="mt-12 text-center h-12 flex items-center justify-center">
        {isLoading && (
